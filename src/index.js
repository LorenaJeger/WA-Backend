...
app.post('/posts/:postId/comments', async (req, res) => {
    ...
    //u Mongu dokumenti unutar postojećih dokumenata ne dobivaju automatski novi _id
    //pa ga moramo dodati sami
    ...
    let result = await db.collection('posts').updateOne(
        ...
        {
           //operacija $push dodaje novu vrijednost u atribut 'comments'
           //ako on ne postoji automatski ga stvara i postavlja na []
           $push: { comments: doc }, 
        }
    );
